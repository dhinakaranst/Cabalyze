...
export default function Footer() {
  return (
    <footer className="glass-dark bg-gradient-to-r from-cyan-900/50 to-blue-900/50 backdrop-blur-lg border-t border-cyan-500/20">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold text-cyan-300 mb-4">Contact Us</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-200">
              <li>
                <a href="#about" className="hover:text-cyan-300 transition-colors duration-300">About Us</a>
              </li>
              <li>
                <a href="#how-it-works" className="hover:text-cyan-300 transition-colors duration-300">How It Works</a>
              </li>
              <li>
          ...
          {/* Social Links */}
          <div>
            <h3 className="text-lg font-semibold text-cyan-300 mb-4">Connect With Me</h3>
        ...
        <div className="mt-8 pt-8 border-t border-cyan-500/20">
          <p className="text-center text-gray-300">
            © {new Date().getFullYear()} Cabalyze. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
